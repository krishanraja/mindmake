...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r40.json");
...
const badManifest = resolve(output, "approved-production-r40-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r40-unanchored.json");
