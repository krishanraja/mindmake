...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r45.json");
...
const badManifest = resolve(output, "approved-production-r45-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r45-unanchored.json");
