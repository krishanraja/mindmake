...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r38.json");
...
const badManifest = resolve(output, "approved-production-r38-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r38-unanchored.json");
