...
gradient.addColorStop(0, 'rgba(126, 244, 194, 0.08)');
gradient.addColorStop(0.5, 'rgba(126, 244, 194, 0.02)');
gradient.addColorStop(1, 'rgba(126, 244, 194, 0.06)');
ctx.fillStyle = gradient;
ctx.fillRect(0, 0, WIDTH, HEIGHT);

// Subtle particle dots (brand element)
ctx.fillStyle = 'rgba(126, 244, 194, 0.15)';
const dots = [
...
ctx.strokeStyle = 'rgba(126, 244, 194, 0.06)';
ctx.lineWidth = 1;
...
topLine.addColorStop(0, 'rgba(126, 244, 194, 0)');
topLine.addColorStop(0.2, 'rgba(126, 244, 194, 0.8)');
topLine.addColorStop(0.8, 'rgba(126, 244, 194, 0.8)');
topLine.addColorStop(1, 'rgba(126, 244, 194, 0)');
...
underline.addColorStop(0, '#7ef4c2');
underline.addColorStop(1, 'rgba(126, 244, 194, 0.3)');
...
bottomLine.addColorStop(0, 'rgba(126, 244, 194, 0)');
bottomLine.addColorStop(0.2, 'rgba(126, 244, 194, 0.6)');
bottomLine.addColorStop(0.8, 'rgba(126, 244, 194, 0.6)');
bottomLine.addColorStop(1, 'rgba(126, 244, 194, 0)');
