...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r32.json");
...
const badManifest = resolve(output, "approved-production-r32-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r32-unanchored.json");
