---
name: mindmaker
description: Canonical reference for Mindmaker, Krish Raja's AI advisory and product business. Use whenever work touches Mindmaker offers, pricing, ICPs, sales, the website (themindmaker.ai), Maven, the Substack, or the CTRL product. NOT Mindmaker OS, which is the autonomous operating system that runs Mindmaker internally. Mindmaker is sold; Mindmaker OS is run. Trigger on any of: "Mindmaker", "CTRL", "mm-ctrl", "ctrl.themindmaker.ai", "Memory Web", "Edge", "Daily Briefing", "Edge Pro", "/cohort", "/enterprise", "/capital", "/immersion", "/workshops", "/alumni", "AI-Fluent Executive", "Signal Session", "Revenue Architecture", "themindmaker.ai", "Maven cohort", "Mindmaker Substack", "ICP", "offer ladder", or any reference to the four-offer architecture, three-ICP framing, CTRL product, or commercial surface. Last reviewed 2026-05-19. Rule: this document captures what is durable. Anything in flux is flagged so the agent does not treat motion as truth.
---

# Mindmaker: Commercial Reference

> **Provenance & reconciliation.** This file is the durable commercial reference originally authored as the `mindmaker` Claude skill (last reviewed 2026-05-19) and stored here on **2026-06-09**, reconciled to the live `krishanraja/mindmaker` site. The skill's own rule holds: it captures what is durable, and anything in flux is flagged. Website-facing facts that changed since the skill was written are corrected inline; the broader business reference (ICPs, CTRL, Substack, Stripe, sales motion, the Mindmaker OS boundary) is preserved as authored. Key changes since 2026-05-19, now reflected below:
> - **The homepage Y-fork is retired.** Every "Book a call" CTA now opens **the Diagnosis Room (Mindy)**, a full-screen on-site experience that diagnoses one nervous AI decision and forks to three honest exits (keep chatting / book a free 15-min call / download a co-branded proposal). See `CLAUDE.md` → "The Diagnosis Room (Mindy)".
> - **Public pricing is ranges only.** Exact figures (kept below as internal reasoning aids) are never shown on the site or in generated proposals; the number is set by Krish on the call.
...
|---|---|---|---|---|
| **The AI-Fluent Executive** (Cohort) | Individual senior leader | 4-week live cohort, Maven-hosted, ~15 seats | $2,500 | Currently named "AI-Fluent Executive". Earlier internal versions used "AI Decision Cohort" at $3,500. The Maven page is canonical. Includes CTRL access. |
...
**The Mindmaker Workshops** ($599 each, Maven-hosted)
Five operator-led single-topic workshops. Cold-buyer wedge. The Workshop pays back a credit ($500, code `WORKSHOP` at Maven checkout, valid 90 days post-workshop) toward the Cohort, making it a feeder. This is the entry rung of the ladder for buyers not yet ready for $2,500. Includes CTRL access.

**The Alumni Pass** ($1,500/year, recurring)
Continuity layer. Quarterly group sessions, alumni-gated, frictionless cancel. This is retention infrastructure, not a primary acquisition path. The page exists but is not linked from nav or footer.

### 2.3 The product line: CTRL
...
### 2.4 The Substack as editorial feeder
...
### 2.5 The ladder (cold buyer to enterprise)
...
Substack free tier
  ↓
Workshop $599 (Maven)              ← entry rung for cold buyers
  ↓
CTRL Free / Diagnostic $49         ← product-led wedge (parallel path)
  ↓
Substack paid $120/year
  ↓
The AI-Fluent Executive $2,500     ← qualifying step (CTRL bundled)
  ↓
CTRL Edge Pro $9/month             ← post-Cohort retention via product
  ↓
Signal Session $15,000             ← enterprise wedge
  ↓
Revenue Architecture $60-100K      ← margin engine
  ↓
Alumni Pass $1,500/year            ← retention layer (post any paid step)
```

The Immersion sits outside this ladder. It is a team-level fast-start, sold direct to companies that want a half-day intervention rather than a full sprint. CTRL also runs as a parallel self-serve path; a buyer can enter the Mindmaker ecosystem entirely through CTRL without ever buying a service offer.

### 2.6 Pricing and framework (resolved 2026-06-09)

**Cohort pricing and duration.** Current, Maven-aligned: Cohort = **$2,500 / 4 weeks** (mostly async + 4 × 90-min live). The older $3,500 / 3-week state is retired. **The Maven page is the canonical source of truth** for cohort price, duration, and curriculum; if asked to write or update any cohort-facing material, confirm the Maven page first, then sync the site. Older user-memory snapshots reference the retired state, treat them as historical context, not current truth.
...
- **Mind Set → Mind Map → Mind Make**, the canonical **cross-offer brand framework**, the spine that spans every offer. Rendered on the homepage by `FrameworkJourney.tsx`. This is the name to use when naming "the Mindmaker framework".
...
**Public pricing is ranges only.** Since June 2026 the live site and any AI-generated proposal show ranges, never exact figures; the exact number is set by Krish on the call. The public range card: Workshops $500–$1,000; Cohort $2,000–$3,000; Signal Session $10,000–$20,000; Revenue Architecture $50,000–$100,000+; Immersion $10,000–$15,000; Alumni Pass ~$1,500/yr; CTRL free, upgrades from $29; bespoke enablement $8,000–$25,000 (pilots from $2,000). The exact figures in the tables below are retained as internal reasoning aids.

---

## 3. The Three ICPs

Mindmaker organizes the commercial surface by ICP, not by product. Same product is framed differently for each buyer.

### 3.1 Individual leaders → `/cohort`
Senior leaders with a nervous AI decision to make. Title patterns: VP, SVP, Director, Head of, Chief. Budget authority: personal or sub-departmental. Pain: "I've tried the tools, watched the tutorials, but I am not faster or sharper." Primary offer: AI-Fluent Executive Cohort ($2,500). Secondary: Workshops ($599) as the entry rung.

### 3.2 Enterprise buyers → `/enterprise`
Companies commercializing AI products or trying to align an exec team on AI. Title patterns: C-suite, EVP, founder. Budget authority: departmental or full P&L. Pain: misalignment, side projects, vendor noise, no production wins. Primary offers: Signal Session ($15K), Revenue Architecture ($60-100K), Immersion ($12K).

### 3.3 Capital allocators → `/capital`
Operating Partners, Managing/General Partners, Principals at PE/VC, family offices, wealth allocators. Pain: the fund is not AI-native; portfolio companies are exposed. Primary offers: Signal Session ($15K, framed as fund-native), Revenue Architecture ($60-100K, framed as per-portco deployment).
...
### 4.1 Routing (live, June 2026)
```
/                      Homepage. NO Y-fork; the hero + CTAs open the Diagnosis Room (Mindy).
/start                 The Diagnosis Room (Mindy) as a standalone page.
/cohort                AI-Fluent Executive. Single product. $2,500.
/enterprise            Enterprise index. Expanding cards: Signal Session, Revenue Architecture, Immersion.
/capital               Capital index. Expanding cards: Signal Session, Revenue Architecture (per-portco).
/immersion             Half-day team session ($12K, inquiry-only). Footer-linked, not nav.
/workshops             Five $599 Maven workshops, indexed.
/workshops/[slug]      Five individual workshop pages.
/alumni                Alumni Pass ($1,500/year). NOT linked from nav or footer. noindex.
...
/sprints → /cohort · /war-room → /enterprise#revenue-architecture · /strategy-day → /enterprise#signal-session.
```
...
CTA labels permitted: "Book a call", "Enrol on Maven", "Start with a free lesson", "Request an invitation".
...
| Buyer pain | Right offer |
|---|---|
| "I want to get sharper on AI but cannot justify $15K solo." | Workshop ($599) → Cohort ($2,500) |
| "I have an AI decision and need a structured way through it." | Cohort ($2,500) |
| "My team is misaligned on AI and I want a half-day to fix it." | Immersion ($12K) |
| "I have one specific AI commercial question and want it resolved fast." | Signal Session ($15K) |
| "I need to commercialize an AI product or rebuild our GTM." | Revenue Architecture ($60-100K) |
| "I am a fund and want my portfolio AI-ready." | Capital → Signal Session and per-portco Revenue Architecture |
| "I went through the Cohort and want to stay in the loop." | Alumni Pass ($1,500/year) |
...
|---|---|---|
| The AI-Fluent Executive | $2,500 | Referential. Maven collects payment. |
| Mindmaker Workshops (×5) | $599 each | Referential. Maven collects payment. |
...
| CTRL: Edge Pro | $9/month recurring | Active. Stripe subscription, signature-verified webhook, idempotent. |
...
When auditing Stripe, archive products outside this canonical list. The dashboard tends to accumulate retired products from earlier iterations of the business (sprints, decision cohorts at $3,500, old workshop bundles, retired CTRL SKUs). These are noise.
...
- **The AI Immersion**
- **The Mindmaker Workshops** (plural collective; individual workshops have their own names)
- **The Alumni Pass**
...
- **Edge Pro** (the $9/month CTRL subscription)
