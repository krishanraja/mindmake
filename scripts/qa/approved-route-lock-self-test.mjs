...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r26.json");
...
const badManifest = resolve(output, "approved-production-r26-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r26-unanchored.json");
