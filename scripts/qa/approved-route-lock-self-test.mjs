...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r44.json");
...
const badManifest = resolve(output, "approved-production-r44-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r44-unanchored.json");
