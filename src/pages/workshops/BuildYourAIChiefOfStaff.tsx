...
const config: WorkshopConfig = {
  ...
  seoDescription:
    "One-day Mindmaker workshop. Build the AI assistant that actually shows up to work, connected to your real inbox, calendar, and chat channels. Deployed live during the session. $599 on Maven.",
  intro: [
