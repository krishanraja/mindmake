...
const config: WorkshopConfig = {
  ...
  seoDescription:
    "One-day Mindmaker workshop. Design the agent fleet your business actually needs. Walk out with a complete agent-native org chart, named roles, and a 90-day build sequence. $599 on Maven.",
  intro: [
