...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r41.json");
...
const badManifest = resolve(output, "approved-production-r41-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r41-unanchored.json");
