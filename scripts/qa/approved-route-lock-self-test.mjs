...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r48.json");
...
const badManifest = resolve(output, "approved-production-r48-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r48-unanchored.json");
