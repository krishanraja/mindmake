...
- **Framework resolved (2026-06-09).** Krish confirmed: **Mind Set → Mind Map → Mind Make** is the canonical cross-offer brand framework. Mindy uses that name when asked what the Mindmaker framework is. **Diagnose → Decompose → Decide → Deploy** is the cohort's week-by-week curriculum only; Mindy uses it when describing how the cohort runs across its four weeks, not as a brand framework. See `CANON.md` §5 for the full resolution.
