...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r30.json");
...
const badManifest = resolve(output, "approved-production-r30-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r30-unanchored.json");
