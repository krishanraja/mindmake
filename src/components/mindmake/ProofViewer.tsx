...
const CAPTURES = [
  {
    ...
    src: brainGraph,
    alt: "CTRL, full app frame: Your Digital Brain graph, 42 things known, 18 confirmed by the owner, one connection open, load-bearing and confirmed",
    caption: "You confirm what is true and fix what is not.",
  },
  {
    id: "evidence",
    ...
    caption: "Sources and strength attached, and what would change it.",
  },
  {
    id: "standards",
    ...
    caption: "Verified by you, or inferred and waiting for your check.",
  },
  {
    id: "briefing",
    ...
    caption: "Shaped around what you are trying to move. It checks its facts with you before it leans on them.",
  },
];
