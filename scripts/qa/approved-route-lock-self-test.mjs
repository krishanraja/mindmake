...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r37.json");
...
const badManifest = resolve(output, "approved-production-r37-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r37-unanchored.json");
