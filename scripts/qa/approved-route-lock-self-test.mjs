...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r28.json");
...
const badManifest = resolve(output, "approved-production-r28-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r28-unanchored.json");
