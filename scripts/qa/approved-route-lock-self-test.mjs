...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r36.json");
...
const badManifest = resolve(output, "approved-production-r36-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r36-unanchored.json");
