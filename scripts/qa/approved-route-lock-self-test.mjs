...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r29.json");
...
const badManifest = resolve(output, "approved-production-r29-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r29-unanchored.json");
