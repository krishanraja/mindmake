...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r34.json");
...
const badManifest = resolve(output, "approved-production-r34-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r34-unanchored.json");
