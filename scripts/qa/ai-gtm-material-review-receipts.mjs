#!/usr/bin/env node
/* Writes the material-review receipts for the /ai-gtm candidate (r47) from
...
const manifestPath = process.argv[2] ?? "quality/ai-gtm/material-review-candidate-r47.json";
