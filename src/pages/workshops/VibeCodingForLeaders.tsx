...
const config: WorkshopConfig = {
  ...
  seoDescription:
    "One-day Mindmaker workshop. Ship the internal tool you've waited six months for IT to build. A working tool at a live URL, deployed by end of day, no coding required. From $500 on Maven.",
  intro: [
