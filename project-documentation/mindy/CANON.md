...
**Last reconciled:** 2026-07-12 against `CLAUDE.md` (repo root) and `project-documentation/` (OFFERS, OUTCOMES, VALUE_PROP, HISTORY, DECISIONS_LOG). No drift found in the offer architecture, pricing, or ICP facts below; verified against the live code (`_shared/lead/`, `_shared/enrich/`) and the current `project-documentation/` set.
