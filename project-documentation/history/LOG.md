...
- No lone word or link on its own line, site-wide, on Krish's ruling after approving the conversion-flow screens, recorded in `quality/route-lock/approved-production-r36.json`.
...
- Conversion flow and page changes, on Krish's brief of 25 September, recorded in `quality/route-lock/approved-production-r36.json`.
