...
Mindmaker has three public offers and one inquiry-only offer. No middle tier.

| Offer | Price | Duration | Audience | Route |
|---|---|---|---|---|
| **The AI Decision Cohort** | $3,500 / seat | 3 weeks (mostly async) + 3 × 90-min live sessions | AI leaders making a nervous decision | `/cohort` (enrolment on Maven) |
...
- A peer network of 10–15 senior operators
- Working fluency with Mind Set → Mind Map → Mind Make
...
Cohort enrollment is the one path that can also flow directly through Maven via the `/cohort` page's "Reserve my seat on Maven" CTA, bypassing the consult call when the buyer already knows the cohort is the right fit.
