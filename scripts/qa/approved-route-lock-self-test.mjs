...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r33.json");
...
const badManifest = resolve(output, "approved-production-r33-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r33-unanchored.json");
