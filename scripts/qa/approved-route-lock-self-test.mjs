...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r39.json");
...
const badManifest = resolve(output, "approved-production-r39-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r39-unanchored.json");
