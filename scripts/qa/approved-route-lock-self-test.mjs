...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r46.json");
...
const badManifest = resolve(output, "approved-production-r46-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r46-unanchored.json");
