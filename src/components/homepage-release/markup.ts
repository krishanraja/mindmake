...
export const homepageMarkup = `<a class="skip-link" href="#history">Skip to the story</a>
    <main id="site" data-release="homepage-integrated-candidate-r3" aria-label="Mindmake homepage">
      ...
      <section id="route" class="r3-section r3-route r3-reveal" data-component="route">
        <div class="r3-variant preview-desktop"><div class="site-frame" data-composition-desktop="balanced" data-title-desktop="balanced" data-measure-desktop="balanced" data-action="copy" data-back="text" data-caption="show" data-receipt="full" data-steps="numbered" data-reveal="staged">
            ...
            <section class="route-stage"><video muted="" loop="" playsinline="" preload="none" aria-hidden="true" poster="${asset5}"><source src="${asset6}" type="video/mp4" media="(min-width: 701px)"></video><div class="wash"></div><button class="back" type="button" data-route-toggle="true">← <span>AI Brain or AI GTM</span></button><div class="route-copy" aria-live="polite"><h2>Own your judgement, and amplify it.</h2><p class="lede">Give your standards, taste and business vision a seat at the table, and level up your capabilities as a leader.</p><button class="primary" type="button" data-start-route="brain">Get your free AI brief <span>→</span></button></div><figure><figcaption>The next decision begins with what the last one taught you.</figcaption></figure><article class="receipt"><header><h3>What stays with you</h3></header><ol><li>Your data & AI brain, built.</li><li>Your decisions and standards, honed to improve you over time.</li><li>The confidence that comes with being an AI business leader.</li></ol></article></section>
            ...
            <section class="route-stage"><video muted="" loop="" playsinline="" preload="none" aria-hidden="true" poster="${asset5}"><source src="${asset6}" type="video/mp4" media="(max-width: 700px)"></video><div class="wash"></div><button class="back" type="button" data-route-toggle="true">← <span>AI Brain or AI GTM</span></button><div class="route-copy" aria-live="polite"><h2>Own your judgement, and amplify it.</h2><p class="lede">Give your standards, taste and business vision a seat at the table, and level up your capabilities as a leader.</p><button class="primary" type="button" data-start-route="brain">Get your free AI brief <span>→</span></button></div><figure><figcaption>The next decision begins with what the last one taught you.</figcaption></figure><article class="receipt"><header><h3>What stays with you</h3></header><ol><li>Your data & AI brain, built.</li><li>Your decisions and standards, honed to improve you over time.</li><li>The confidence that comes with being an AI business leader.</li></ol></article></section>
          </div></div>
      </section>
      <section id="footer" class="r3-footer r3-reveal" data-component="footer"><div class="r3-variant preview-desktop"><footer class="site-footer" data-structure-desktop="rail" data-density-desktop="compact" data-brand="full" data-statement="short" data-routes="single" data-legal="bottom" data-copyright="short" data-ground="dark" data-rule="accent" data-reveal="scroll"><div class="brand-block"><a class="brand" href="/" aria-label="Mindmake home"><img class="mark" src="${asset0}" alt=""><img class="wordmark" src="${asset1}" alt="Mindmake"></a><p class="footer-statement">Keep your edge as AI<br>changes the market.</p><a class="mm-subscribe-cta" href="https://mindmakerlive.substack.com/subscribe" target="_blank" rel="noreferrer" data-subscribe-source="homepage_footer">Subscribe for free <span aria-hidden="true">↗</span></a></div><nav class="footer-routes" aria-label="Footer navigation"><a href="/">Home</a><a href="/ai-brain">Build your AI brain</a><a href="/ai-gtm">Build your AI GTM</a><a href="/case-studies">Success stories</a><a href="/blog">Ideas you can use</a><a href="/faq">Questions we get asked</a><a href="/about">About us</a><a href="https://mindmakerlive.substack.com/subscribe" target="_blank" rel="noreferrer">Media</a><a href="/start">Get your free AI brief</a></nav><nav class="legal" aria-label="Legal navigation"><a href="/privacy">Privacy</a><a href="/terms">Terms</a></nav><small>© 2026 Mindmake.</small></footer></div><div class="r3-variant preview-mobile"><footer class="site-footer" data-structure-mobile="compact" data-density-mobile="compact" data-brand="full" data-statement="short" data-routes="single" data-legal="bottom" data-copyright="short" data-ground="dark" data-rule="accent" data-reveal="scroll"><div class="brand-block"><a class="brand" href="/" aria-label="Mindmake home"><img class="mark" src="${asset0}" alt=""><img class="wordmark" src="${asset1}" alt="Mindmake"></a><p class="footer-statement">Keep your edge as AI<br>changes the market.</p><a class="mm-subscribe-cta" href="https://mindmakerlive.substack.com/subscribe" target="_blank" rel="noreferrer" data-subscribe-source="homepage_footer">Subscribe for free <span aria-hidden="true">↗</span></a></div><nav class="legal" aria-label="Legal navigation"><a href="/privacy">Privacy</a><a href="/terms">Terms</a></nav><small>© 2026 Mindmake.</small></footer></div></section>
    </main>
    <aside class="r3-navigation" aria-hidden="true" aria-label="Site navigation" role="dialog" aria-modal="true" inert><div class="r3-variant preview-desktop"><div class="site-frame" data-structure-desktop="index" data-scale-desktop="balanced" data-density-desktop="balanced" data-order="build" data-secondary="footer" data-active="rule" data-action="bar" data-ground="solid" data-entrance="stepped">
              ...
              <div class="menu-surface"><nav class="primary-routes" aria-label="Main navigation"><a href="/">Home</a><a href="/ai-brain">Build your AI brain</a><a href="/ai-gtm">Build your AI GTM</a><a href="/case-studies">Success stories</a><a href="/blog">Ideas you can use</a><a href="/faq">Questions we get asked</a><a href="/about">About us</a><a href="https://mindmakerlive.substack.com/subscribe" target="_blank" rel="noreferrer" class="mm-route-badged" data-badge="Subscribe for free">Media</a></nav><a class="start-action" type="button" href="/start">Get your free AI brief <span aria-hidden="true">→</span></a><nav class="secondary-routes" aria-label="Additional navigation"><a href="/privacy">Privacy</a><a href="/terms">Terms</a></nav></div>
