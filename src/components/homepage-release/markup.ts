...
export const homepageMarkup = `<a class="skip-link" href="#history">Skip to the story</a>
    ...
    <aside class="r3-navigation" aria-hidden="true" aria-label="Site navigation" role="dialog" aria-modal="true" inert><div class="r3-variant preview-desktop"><div class="site-frame" data-structure-desktop="index" data-scale-desktop="balanced" data-density-desktop="balanced" data-order="build" data-secondary="footer" data-active="rule" data-action="bar" data-ground="solid" data-entrance="stepped">
              ...
              <div class="menu-surface"><nav class="primary-routes" aria-label="Main navigation"><a href="/">Home</a><a href="/ai-brain">Build your AI brain</a><a href="/ai-gtm">Build your AI GTM</a><a href="/case-studies">Success stories</a><a href="/blog">Ideas you can use</a><a href="/answers">Quick AI tips</a><a href="/faq">Questions we get asked</a><a href="/about">About us</a><a href="https://mindmakerlive.substack.com/subscribe" target="_blank" rel="noreferrer" class="mm-route-badged" data-badge="Subscribe for free">Media</a></nav><a class="start-action" type="button" href="/start">Get your free AI brief <span aria-hidden="true">→</span></a><nav class="secondary-routes" aria-label="Additional navigation"><a href="/privacy">Privacy</a><a href="/terms">Terms</a></nav></div>
