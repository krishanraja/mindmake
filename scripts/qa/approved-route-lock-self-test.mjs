...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r31.json");
...
const badManifest = resolve(output, "approved-production-r31-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r31-unanchored.json");
