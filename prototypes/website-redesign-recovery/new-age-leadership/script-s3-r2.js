(() => {
  ...
  const stopBenefits = () => { clearInterval(benefitTimer); benefitTimer = 0; };
  ...
  benefitsRoot?.addEventListener('mouseenter', () => { benefitHeld = true; stopBenefits(); });
  benefitsRoot?.addEventListener('mouseleave', () => { benefitHeld = false; startBenefits(); });
  ...
  if (benefitsRoot) {
    new IntersectionObserver(entries => {
      ...
      benefitVisible ? startBenefits() : stopBenefits();
