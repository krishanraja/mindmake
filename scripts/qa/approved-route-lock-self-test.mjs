...
const manifestPath = resolve(root, "quality/route-lock/approved-production-r35.json");
...
const badManifest = resolve(output, "approved-production-r35-bad.json");
...
const unanchoredManifest = resolve(output, "approved-production-r35-unanchored.json");
